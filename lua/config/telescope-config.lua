...
vim.keymap.set('n', '<leader>gn', function() return require('config.telescope-config').grep_notes() end, {noremap = true})

vim.keymap.set('n', '<leader>fn', function() return require('config.telescope-config').find_notes() end, {noremap = true})

vim.keymap.set('n', '<leader>gp', function() return require('config.telescope-config').grep_projects() end, {noremap = true})

vim.keymap.set('n', '<leader>fp', function() return require('config.telescope-config').find_projects() end, {noremap = true})

vim.keymap.set('n', '<leader>fv', function() return require('config.telescope-config').find_vim_files() end, {noremap = true})
